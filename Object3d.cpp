...
Object3d * Object3d::Create(Model* model = nullptr)
{
	// 3Dオブジェクトのインスタンスを生成
	...
	if (model)	object3d->SetModel(model);
...
void Object3d::Update()
{
	...
	constMap1->ambient = model->GetMaerial().ambient;
	constMap1->diffuse = model->GetMaerial().diffuse;
	constMap1->specular = model->GetMaerial().specular;
	constMap1->alpha = model->GetMaerial().alpha;
